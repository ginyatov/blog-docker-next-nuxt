...
export type AuthControllerRegistrationProps = Omit<MutateProps<RegisterEntity, unknown, void, RegisterAuthDto, void>, "path" | "verb">;

export const AuthControllerRegistration = (props: AuthControllerRegistrationProps) => (
  <Mutate<RegisterEntity, unknown, void, RegisterAuthDto, void>
    verb="POST"
...
export type UseAuthControllerRegistrationProps = Omit<UseMutateProps<RegisterEntity, unknown, void, RegisterAuthDto, void>, "path" | "verb">;

export const useAuthControllerRegistration = (props: UseAuthControllerRegistrationProps) => useMutate<RegisterEntity, unknown, void, RegisterAuthDto, void>("POST", `/auth/registration`, props);
...
export interface UsersControllerFindAllResponse {[key: string]: any}

export type UsersControllerFindAllProps = Omit<GetProps<UsersControllerFindAllResponse, unknown, void, void>, "path">;

export const UsersControllerFindAll = (props: UsersControllerFindAllProps) => (
  <Get<UsersControllerFindAllResponse, unknown, void, void>
    path={`/users`}
...
export type UseUsersControllerFindAllProps = Omit<UseGetProps<UsersControllerFindAllResponse, unknown, void, void>, "path">;

export const useUsersControllerFindAll = (props: UseUsersControllerFindAllProps) => useGet<UsersControllerFindAllResponse, unknown, void, void>(`/users`, props);


export interface UsersControllerFindOnePathParams {
  id: string
}

export type UsersControllerFindOneProps = Omit<GetProps<UserEntity, unknown, void, UsersControllerFindOnePathParams>, "path"> & UsersControllerFindOnePathParams;

export const UsersControllerFindOne = ({id, ...props}: UsersControllerFindOneProps) => (
  <Get<UserEntity, unknown, void, UsersControllerFindOnePathParams>
    path={`/users/${id}`}
...
export type UseUsersControllerFindOneProps = Omit<UseGetProps<UserEntity, unknown, void, UsersControllerFindOnePathParams>, "path"> & UsersControllerFindOnePathParams;

export const useUsersControllerFindOne = ({id, ...props}: UseUsersControllerFindOneProps) => useGet<UserEntity, unknown, void, UsersControllerFindOnePathParams>((paramsInPath: UsersControllerFindOnePathParams) => `/users/${paramsInPath.id}`, {  pathParams: { id }, ...props });


export interface UsersControllerUpdatePathParams {
  id: string
}

export type UsersControllerUpdateProps = Omit<MutateProps<UserEntity, unknown, void, UpdateUserDto, UsersControllerUpdatePathParams>, "path" | "verb"> & UsersControllerUpdatePathParams;

export const UsersControllerUpdate = ({id, ...props}: UsersControllerUpdateProps) => (
  <Mutate<UserEntity, unknown, void, UpdateUserDto, UsersControllerUpdatePathParams>
    verb="PATCH"
    path={`/users/${id}`}
...
export type UseUsersControllerUpdateProps = Omit<UseMutateProps<UserEntity, unknown, void, UpdateUserDto, UsersControllerUpdatePathParams>, "path" | "verb"> & UsersControllerUpdatePathParams;

export const useUsersControllerUpdate = ({id, ...props}: UseUsersControllerUpdateProps) => useMutate<UserEntity, unknown, void, UpdateUserDto, UsersControllerUpdatePathParams>("PATCH", (paramsInPath: UsersControllerUpdatePathParams) => `/users/${paramsInPath.id}`, {  pathParams: { id }, ...props });


export type UsersControllerRemoveProps = Omit<MutateProps<UserEntity, unknown, void, string, void>, "path" | "verb">;

export const UsersControllerRemove = (props: UsersControllerRemoveProps) => (
  <Mutate<UserEntity, unknown, void, string, void>
    verb="DELETE"
    path={`/users`}
...
export type UseUsersControllerRemoveProps = Omit<UseMutateProps<UserEntity, unknown, void, string, void>, "path" | "verb">;

export const useUsersControllerRemove = (props: UseUsersControllerRemoveProps) => useMutate<UserEntity, unknown, void, string, void>("DELETE", `/users`, {   ...props });
